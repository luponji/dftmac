...
class MainWindow(QMainWindow):
    ...
    def open_file(self):
        ...
        cm_w = width / 300 * 2.54
        cm_h = height / 300 * 2.54

        quality = "🟢 Ottima"
        if cm_w < 30 or cm_h < 30:
            quality = "🟡 Buona"
        if cm_w < 15 or cm_h < 15:
            quality = "🔴 Limitata"

        self.info.setText(
            f"""📋 Informazioni Grafica
...
"""
    ...
    def save_image(self):
        ...
        start_dir = ""
        if self.export_mode.currentText() == "Stessa cartella dell'originale" and self.current_file:
        ...
        final_path = os.path.join(folder, name + ".png")

        cv2.imwrite(final_path, self.optimized_image)

        self.info.setText("Salvato:\n" + final_path)
